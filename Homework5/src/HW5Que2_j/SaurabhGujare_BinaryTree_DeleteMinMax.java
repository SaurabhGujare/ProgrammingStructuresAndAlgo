 ...
 * @NUID 001424874
 */
public class SaurabhGujare_BinaryTree_DeleteMinMax {
    class Node{
        int key;
        Node left;
        Node right;
    ...
    public SaurabhGujare_BinaryTree_DeleteMinMax() {
        this.root = null;
    }
    ...
    public static void main(String[] args){
        SaurabhGujare_BinaryTree_DeleteMinMax binaryTree = new SaurabhGujare_BinaryTree_DeleteMinMax();
